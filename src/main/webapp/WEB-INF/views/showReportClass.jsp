    ...
    <div align="center">
        ...
        <sform:form method="post" action="addAssignTeacherToClass"  modelAttribute="assignTeacherToClassCommand">
            ...
            <fieldset style="width: 600px; display: flex; flex-direction: column; align-items: start">
                ...
                <c:forEach items="${assignTeacherToClassCommand.aClass.subjects}" var="subject">
                    <fieldset style="width: 600px; display: flex; flex-direction: column; align-items: start">
                        ...
                        <c:forEach items="${subject.teachers}" var="teacher">
                            <label>
                                <sform:checkbox path="teacherListId" value="${subject.subjectId}|${teacher.teacherId}" checked="${teacher.checked}" /> ${teacher.name}
                            </label><br/>
                        </c:forEach>
